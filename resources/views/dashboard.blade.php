            ...
            <div
                ...
                <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
                    <img class="object-cover w-full h-full"
                        src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?auto=format&fit=crop&w=500&q=60"
                        alt="product image" />
                    <span
                ...
                <div class="mt-4 px-5 pb-5">
                    ...
                    <div class="mt-2 mb-5 flex items-center justify-between">
                        <p>
                            ...
                            <span class="text-sm text-slate-500 line-through">$699</span>
                        </p>
                        <div class="flex items-center">
                            ...
                            @endfor
                            <span class="ml-3 rounded bg-yellow-200 px-2.5 py-0.5 text-xs font-semibold">5.0</span>
                        </div>
                    </div>
